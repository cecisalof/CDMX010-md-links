...
* Tu módulo puede ser instalable via `npm install <github-user>/md-links`. Este
  módulo puede incluir tanto un _ejecutable_ que podamos invocar en la línea de
...
No dudes en consultar a tus compañeras, coaches y/o el [foro de la comunidad](https://community.laboratoria.la/c/js)
...
El valor de retorno de nuestra librería es una **Promesa**, no un _Array_.
